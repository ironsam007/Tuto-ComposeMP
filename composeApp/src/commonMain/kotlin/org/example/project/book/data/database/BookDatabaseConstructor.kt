...
/* Call the correct platform code to instantiate the room database
...
}// and to initailize/instantiate or create the database instance its gonna need the DatabaseFactory on each platform to create the Room DB builder